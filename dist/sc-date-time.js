      ...
      controller: [
        '$scope', 'scDateTimeI18n', function(scope, scDateTimeI18n) {
          ...
          scope.clock = {
            _minutes: 0,
            _hours: 0,
            _incrementMinutesBy: scDateTimeConfig.incrementMinutesBy,
            ...
            _incMinutes: function(inc) {
              this._minutes = Math.max(0, Math.min(60, this._minutes + inc));
              if (isNaN(this._minutes) || this._minutes >= 60) {
